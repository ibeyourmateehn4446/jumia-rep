...
const LoadingSkeleton = () => {
  return (
    <div className="my-1 cursor-pointer bg-white flex flex-col hover:shadow-md hover:scale-[1.01] h-[120px] md:h-[150px] w-[90px] md:w-[130px] focus:outline-0 rounded-md p-1 lg:p-0">
