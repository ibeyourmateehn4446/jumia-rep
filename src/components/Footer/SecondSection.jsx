  ...
  return (
    <div className="lg:pb-5 px-[55px] bg-[#535357] text-white">
      <div className="hidden pt-5 lg:flex flex-col item md:flex-row justify-between">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            <h5 className="text-[11px] hover:underline mb-1">
              How to shop on WHYLAGOS?
            </h5>
            <h5 className="text-[11px] hover:underline mb-1">
              Delivery options and timelines
            </h5>
            <h5 className="text-[11px] hover:underline mb-1">
              How to return a product on WHYLAGOS! ?
            </h5>
            <h5 className="text-[11px] hover:underline mb-1">
        ...
        <div className="flex flex-col">
          <h3 className="text-xs font-bold mb-3">ABOUT WHYLAGOS! </h3>
          <div className="flex flex-col">
            <h5 className="text-[11px] hover:underline mb-1">About us</h5>
            <h5 className="text-[11px] hover:underline mb-1">WH?LAGOS! careers</h5>
            <h5 className="text-[11px] hover:underline mb-1">WH?LAGOS! Express</h5>
            <h5 className="text-[11px] hover:underline mb-1">
            ...
            <h5 className="text-[11px] hover:underline mb-1">WH?LAGOS! Global</h5>
            <h5 className="text-[11px] hover:underline mb-1">
              Official Stores
            </h5>
            <h5 className="text-[11px] hover:underline mb-1">Flash Sales</h5>
            <h5 className="text-[11px] hover:underline mb-1">
              WHYLAGOS! Anniversary 2023
            </h5>
          </div>
        </div>

        <div className="flex flex-col">
          <h3 className="text-xs font-bold mb-3">MAKE MONEY WITH WHYLAGOS!</h3>
          <div className="flex flex-col">
            <h5 className="text-[11px] hover:underline mb-1">Sell on WHYLAGOS!</h5>
            <h5 className="text-[11px] hover:underline mb-1">
            ...
            <h5 className="text-[11px] hover:underline mb-1">
              Join the WHYLAGOS! DA Academy
            </h5>
            <h5 className="text-[11px] hover:underline mb-1">
              Join the WHYLAGOS! KOL Program
            </h5>
          </div>
        </div>

        <div className="flex flex-col">
          <h3 className="text-xs font-bold mb-3">WHYLAGOS! INTERNATIONAL</h3>
